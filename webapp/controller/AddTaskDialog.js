sap.ui.define([
	...
	return Controller.extend("productSupport.scheduler.controller.AddTaskDialog", {
		...
		open: function () {
			if (!this._oDialog){
				this._oDialog = sap.ui.xmlfragment("productSupport.scheduler.view.AddTaskDialog", this);
				this._oDialog.setModel(sap.ui.getCore().byId("addTaskDialog").getModel());
			}
		...
		onAddTask: function (oEvent) {
			...
			document.location.href="controller/addTask.php?fname="+fname+"&lname="+lname+"&email="+email+"&team="+team;
